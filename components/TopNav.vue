    ...
    <div>
        <div class="nav flex items-center">
            ...
            <!--<div class="ml-auto" v-if="isSearching" @blur="isSearching=0">-->
                ...
                <!--&lt;!&ndash;<input ref="search"&ndash;&gt;-->
                <!--&lt;!&ndash;id="top-nav-search"&ndash;&gt;-->
                <!--&lt;!&ndash;class="nav&#45;&#45;search text w-64 p-2"&ndash;&gt;-->
                <!--&lt;!&ndash;placeholder="Search"&ndash;&gt;-->
                <!--&lt;!&ndash;@focus="isSearching=1"&ndash;&gt;-->
                <!--&lt;!&ndash;@blur="isSearching=0"&ndash;&gt;-->
                <!--&lt;!&ndash;&gt;&ndash;&gt;-->
            <!--</div>-->
        </div>
    </div>
